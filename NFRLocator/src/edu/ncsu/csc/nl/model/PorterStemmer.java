...
/*
   ...
   Release 5: Slankas, added a convenience method and constructor, 2011 Oct 11.  moved some variable initialization
...
{  
   ...
   /**
    * Convenience method for using the PorterStemmer.
    * 
    * @param s
    * @return
    */
